      ...
      <main className="pt-36 pb-24 px-6 max-w-2xl mx-auto">
        ...
        <div className="bg-surface-container-lowest rounded-card p-8 shadow-[0_4px_24px_rgba(25,28,29,0.06)]">
          <p className="font-body text-on-surface-variant text-sm leading-relaxed">
            Diese Seite ist im Aufbau. Die vollständige Datenschutzerklärung
            wird nach Abschluss des Testbetriebs ergänzt.
          </p>
          <p className="font-body text-on-surface-variant text-sm leading-relaxed mt-4">
            Hinweis: Es werden keine Patientendaten gespeichert. Patientennamen
            werden ausschließlich lokal im Browser gehalten und nie an Server
            übermittelt.
          </p>
        </div>
      </main>
